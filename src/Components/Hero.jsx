    ...
    <div className="flex flex-col items-center text-center space-y-8">
      ...
      <div className="space-y-4">
        <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight drop-shadow-lg">
          Hi, I'm <span className="text-white/90">[Your Name]</span>
        </h1>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
        ...
        <button className="px-8 py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-semibold shadow-2xl transition-all active:scale-95 flex items-center gap-2">
